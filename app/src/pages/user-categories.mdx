...
* Askers fall into two categories:<br/>
  * <span class="text-emerald-500">Asker-maker</span>: a user who generates a new scenario on the platform by defining the parameters for their notification and paying ETH to create a scenario pool. <br/>
...
* Any user of the platform can act as a confirmer-maker or a confirmer-joiner at any time.
