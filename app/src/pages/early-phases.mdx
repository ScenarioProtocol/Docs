...
* Bootstrapping phase
    ...
    * solutions: targeted and phased access whitelists; reputation scoring phase which explicitly acts as a precursor to token distribution; 
    * goal: attract repeat users who populate the protocol with organic, genuine, high-quality scenario pools and confirmations
    * solutions: supplement initial pool bounties with reputation points (and with SNR token distributions following TGE); actively monitor early user behaviour in order to reward high-quality scenario pools and penalise dishonest behaviour, spam or sybil attacks.
