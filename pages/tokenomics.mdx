...
The SNR token will be a standard ERC-20 token with a maximum supply of 1 billion (1,000,000,000). It will not be minted immediately, instead being introduced as part of a token generation event (TGE) which will follow an initial period of more limited-functionality protocol testing and user reputation scoring. (See [Staged Roll-out](/rollout)). There will be no tail emissions or ongoing inflation of the token supply; 4 years after the TGE, the supply will be fully distributed (note: fully vesting the supply will take one additional year).
...
* <span class="text-white">15%</span> will be allocated to a early backers
* <span class="text-white">13%</span> will be allocated to the founding team
* <span class="text-white">5%</span> will be allocated to a community marketing and partnering fund
* <span class="text-white">2%</span> will be allocated to advisors
