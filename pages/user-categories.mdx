...
* Confirmers play a crucial role in ‘keeping the machine running’ by resolving scenario pools and triggering notifications for askers. Confirmers are incentivised to perform this role to a high standard. Confirmers will usually be engaged users who are likely to represent a smaller percentage of all users once the protocol has scaled.
